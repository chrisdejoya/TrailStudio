...
const old = content.substring(startIdx, endIdx);

const newContent = `<!-- Image Based Lighting Panel -->
    <div class="panel">
...
const result = content.substring(0, startIdx) + newContent + content.substring(endIdx);
fs.writeFileSync('D:\\Dev\\TrailStudio\\ui\\ui.html', result.replace(/\n/g, '\r\n'));
